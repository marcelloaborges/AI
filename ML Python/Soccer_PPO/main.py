...
goalie_optimizer = optim.RMSprop( list( goalie_model.parameters() ) + list( critic_goalie_model.parameters() ), lr=LR, alpha=0.99, eps=1e-5 )
striker_optimizer = optim.RMSprop( list( striker_model.parameters() ) + list( critic_striker_model.parameters() ), lr=LR, alpha=0.99, eps=1e-5 )
...
goalie_0 = PPOAgent( DEVICE, GOALIE_0_KEY, goalie_model, critic_goalie_model, goalie_optimizer, N_STEP, GAMMA, EPSILON, ENTROPY_WEIGHT, GRADIENT_CLIP )
striker_0 = PPOAgent( DEVICE, STRIKER_0_KEY, striker_model, critic_striker_model, striker_optimizer, N_STEP, GAMMA, EPSILON, ENTROPY_WEIGHT, GRADIENT_CLIP )

goalie_1 = PPOAgent( DEVICE, GOALIE_1_KEY, goalie_model, critic_goalie_model, goalie_optimizer, N_STEP, GAMMA, EPSILON, ENTROPY_WEIGHT, GRADIENT_CLIP )
striker_1 = PPOAgent( DEVICE, STRIKER_1_KEY, striker_model, critic_striker_model, striker_optimizer, N_STEP, GAMMA, EPSILON, ENTROPY_WEIGHT, GRADIENT_CLIP )
