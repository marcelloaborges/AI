...
class DDQN(nn.Module):
    def __init__(self, encoded_state_size, action_size, fc1_units=128, fc2_units=128):
        ...
        self.lstm_x2h = layer_init( nn.Linear( encoded_state_size, 256 * 4 ) )
        self.lstm_h2h = layer_init( nn.Linear( 256, 256 * 4 ) )

        # FC

        self.fc1 = layer_init( nn.Linear(256, fc1_units) )
    ...
    def forward(self, encoded_state, hx, cx):

        # LSTM
        gates = self.lstm_x2h(encoded_state) + self.lstm_h2h(hx)
